...
public class GraphQlQueryBuilder
{
    ...
    /// <summary>
    ///     Adds a field to the query with the given field name and allows for building a nested sub-query using the subBuilder
    ///     action.
    /// </summary>
    ...
    /// <summary>
    ///     Adds an argument to the current field with the given argument name and allows for building a nested sub-query using
    ///     the subBuilder action.
    /// </summary>
